...
trap_dispatch(struct Trapframe *tf)
{
	...
	switch (tf->tf_trapno) {
		...
		case T_SYSCALL:
			...
			// cprintf("Trap dispatched to syscall\n");
			...
			// cprintf("Returned from trap dispatch, case syscall\n");

			// syscalls use the trap frame created by int in lib/syscall.c and the consequent
			// hardware and software handler to create a trap frame to transfer 
			// and RETURN register arguments
...
{
	// cprintf("trap.c: page_fault_handler\n");
